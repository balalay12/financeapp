...
urlpatterns = [
    ...
    url(r'^balance/update/(?P<pk>[0-9]+)/$', views.BalanceUpdate.as_view(), name='update_balance'),
    url(r'^balance/delete/(?P<pk>[0-9]+)/$', views.BalanceDelete.as_view(), name='delete_balance')
]
